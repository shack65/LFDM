...
#define CONFIG_EXAMPLES_DIR "Lfdm_skr3"
...
#define STRING_CONFIG_H_AUTHOR "(SMHACK65)" // Original author or contributor.
 ...
 * This allows the connection of wireless adapters (for instance) to non-port pins.
...
#define CUSTOM_MACHINE_NAME "LFMD_BTT_SKR3"
 ...
 * Stepper Drivers
 *
 * These settings allow Marlin to tune stepper driver tim ing and enable advanced options for
...
#define Z_DRIVER_TYPE  TMC2209  //Z1 motor
...
#define W_DRIVER_TYPE  E1
#define E0_DRIVER_TYPE TMC2209
#define E1_DRIVER_TYPE TMC2209  //Z2 motor
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 200, 93, 200 }
// TITAN EXTRUDER:
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 25,5 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 100, 5000, 100 }
 ...
 * Z_MIN_PROBE_PIN
 *
 * Override t%his pin only if the probe cannot be connected to
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.5, 0, -1 }
